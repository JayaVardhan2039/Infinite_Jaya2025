...
namespace Code_Challenge_10.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "fn_customercountry")]
        public virtual IQueryable<fn_customercountry_Result> fn_customercountry(string countryname)
        {
            var countrynameParameter = countryname != null ?
                new ObjectParameter("countryname", countryname) :
                new ObjectParameter("countryname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_customercountry_Result>("[NorthwindEntities].[fn_customercountry](@countryname)", countrynameParameter);
        }
